package com.training.akka.demoDevice;
    ...
    if (this.groupId.equals(trackMsg.groupId)) {
      ...
      if (deviceActor != null) {
        deviceActor.forward(trackMsg, getContext());
				 ...
				 * else { log.info("Creating device actor for {}", trackMsg.deviceId);
				 * deviceActor = getContext().actorOf(Device.props(groupId, trackMsg.deviceId),
				 * "device-" + trackMsg.deviceId); deviceIdToActor.put(trackMsg.deviceId,
				 * deviceActor); deviceActor.forward(trackMsg, getContext()); }
				 */
      else {
